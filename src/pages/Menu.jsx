...
export default function Menu() {
    ...
    let rest=()=>{
        axios.get('http://localhost:5000/top-restaurant-chains')
        .then((res)=>res.data)
      ...
      <section className='py-[30px] select-none'>
        <div className='max-w-[1120px] mx-auto border-b'>
            <div className='flex items-center justify-between'>
                <h1 className='font-bold text-[22px]'>Restaurant with online food delviry in Chandigarh</h1>
            ...
            <div className='grid grid-cols-4 gap-[30px] py-[30px]'>
                {
                    loop.map((v,i)=>{
                        return(
                            <div>
                                <div className='h-[160px] shadow-[inset_0px_-25px_15px_0px_black] bg-no-repeat bg-cover rounded-[10px] relative' style={{backgroundImage:`url(http://localhost:5000/images/${v.image})`}}>
